...
namespace MobileService.Tests.Core.Queries.Flashcards
{
    ...
    public class GetFlashcardsListWithProgressesParallelHTests
    {
        [Fact]
        public async Task TestA()
        {
            ...
            var output = await mediator.Send(new GetFlashcardsListWithProgressesParallelQ(Guid.Parse("d30c8f79-291b-4532-8f22-b693e61d6bb5"), "9a4e1d79-d64e-4ec4-85e5-53bdef5043f4"));
